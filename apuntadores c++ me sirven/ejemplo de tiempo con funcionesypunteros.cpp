//ejemplo de tiempo con funciones

#include<stdio.h>


void funcionTiempo(int , int );
...
printf("\n%d horas  con %d minutos  y  %d segundos ",horas, minutos,segundos);         //los minutos y segundos vuelven a ser los mismos introducidos pr el usuario
