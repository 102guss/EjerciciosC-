...
int main()
{
  ...
  matriz=(int **)malloc(filas*sizeof(int *));//reserva memoria para un vector del arreglo de apuntadores
  
  for (j=0;j<columnas;j++)
    matriz[j]=(int*)malloc(columnas*sizeof(int));//para crear la matriz completa del arreglo de apuntadores(para cada arreglo de arreglos)
