...
int *fun(int *vectooor1, int taaam){  //aqui si me va aretornar un apuntador  a un vector de enteros
	
	int *nuevovector;  //es el que voy a retornar, pero sin asterisco
	int i;
	int j=0;
	
	nuevovector= (int *)malloc(   npar(vectooor1,taaam)   *sizeof(int));//apartame el tamaño necesario qu ocupa npar y asignaselo a nueovector
